...
static const _SafetyStatus_type_support_symbol_names_t _SafetyStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, safe_teleop_core, msg, SafetyStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, safe_teleop_core, msg, SafetyStatus)),
  }
};
...
{
  return &::safe_teleop_core::msg::rosidl_typesupport_cpp::SafetyStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, safe_teleop_core, msg, SafetyStatus)() {
  return get_message_type_support_handle<safe_teleop_core::msg::SafetyStatus>();
}
