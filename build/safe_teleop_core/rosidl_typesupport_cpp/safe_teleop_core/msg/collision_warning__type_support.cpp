...
static const _CollisionWarning_type_support_symbol_names_t _CollisionWarning_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, safe_teleop_core, msg, CollisionWarning)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, safe_teleop_core, msg, CollisionWarning)),
  }
};
...
{
  return &::safe_teleop_core::msg::rosidl_typesupport_cpp::CollisionWarning_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, safe_teleop_core, msg, CollisionWarning)() {
  return get_message_type_support_handle<safe_teleop_core::msg::CollisionWarning>();
}
