...
bool safe_teleop_core__msg__safety_zone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("safe_teleop_core.msg._safety_zone.SafetyZone", full_classname_dest, 44) == 0);
  }
  safe_teleop_core__msg__SafetyZone * ros_message = _ros_message;
  {  // header
  ...
  {  // velocity_magnitude
    PyObject * field = PyObject_GetAttrString(_pymsg, "velocity_magnitude");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->velocity_magnitude = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * safe_teleop_core__msg__safety_zone__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("safe_teleop_core.msg._safety_zone");
  ...
  {  // velocity_magnitude
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->velocity_magnitude);
    {
      int rc = PyObject_SetAttrString(_pymessage, "velocity_magnitude", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
