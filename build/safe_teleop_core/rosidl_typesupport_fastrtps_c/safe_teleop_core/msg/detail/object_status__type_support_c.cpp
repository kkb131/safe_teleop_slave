...
#include "safe_teleop_core/msg/detail/object_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // object_id, object_type
#include "rosidl_runtime_c/string_functions.h"  // object_id, object_type
...
using _ObjectStatus__ros_msg_type = safe_teleop_core__msg__ObjectStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detection_confidence
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = safe_teleop_core__msg__ObjectStatus;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const safe_teleop_core__msg__ObjectStatus * ros_message = static_cast<const safe_teleop_core__msg__ObjectStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_safe_teleop_core__msg__ObjectStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  safe_teleop_core__msg__ObjectStatus * ros_message = static_cast<safe_teleop_core__msg__ObjectStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_safe_teleop_core__msg__ObjectStatus(cdr, ros_message);
}

static uint32_t _ObjectStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_safe_teleop_core__msg__ObjectStatus(
...
static size_t _ObjectStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_safe_teleop_core__msg__ObjectStatus(
