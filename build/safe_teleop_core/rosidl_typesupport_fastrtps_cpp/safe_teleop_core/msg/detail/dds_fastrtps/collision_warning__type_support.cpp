...
#include "safe_teleop_core/msg/detail/collision_warning__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const safe_teleop_core::msg::CollisionWarning & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  safe_teleop_core::msg::CollisionWarning & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_safe_teleop_core
max_serialized_size_CollisionWarning(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = safe_teleop_core::msg::CollisionWarning;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_safe_teleop_core
max_serialized_size_key_CollisionWarning(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const safe_teleop_core::msg::CollisionWarning *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<safe_teleop_core::msg::CollisionWarning *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CollisionWarning__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const safe_teleop_core::msg::CollisionWarning *>(
...
static size_t _CollisionWarning__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CollisionWarning(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CollisionWarning__callbacks = {
...
static rosidl_message_type_support_t _CollisionWarning__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CollisionWarning__callbacks,
...
get_message_type_support_handle<safe_teleop_core::msg::CollisionWarning>()
{
  return &safe_teleop_core::msg::typesupport_fastrtps_cpp::_CollisionWarning__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, safe_teleop_core, msg, CollisionWarning)() {
  return &safe_teleop_core::msg::typesupport_fastrtps_cpp::_CollisionWarning__handle;
}
