...
: ${AMENT_CURRENT_PREFIX:="/workspaces/safe_teleop_slave_ws/install/safe_teleop_realtime"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/safe_teleop_realtime/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/safe_teleop_realtime/environment/path.sh"
