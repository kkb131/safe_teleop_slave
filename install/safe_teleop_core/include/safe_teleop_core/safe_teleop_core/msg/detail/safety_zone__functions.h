...
#ifndef SAFE_TELEOP_CORE__MSG__DETAIL__SAFETY_ZONE__FUNCTIONS_H_
#define SAFE_TELEOP_CORE__MSG__DETAIL__SAFETY_ZONE__FUNCTIONS_H_
 ...
 * )) before or use
 * safe_teleop_core__msg__SafetyZone__create()
 ...
 * calls
 * safe_teleop_core__msg__SafetyZone__init().
...
/**
 * It calls
 * safe_teleop_core__msg__SafetyZone__fini()
 ...
 * safe_teleop_core__msg__SafetyZone__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * safe_teleop_core__msg__SafetyZone__Sequence__fini()
 * on the array,
...
#endif  // SAFE_TELEOP_CORE__MSG__DETAIL__SAFETY_ZONE__FUNCTIONS_H_
