...
#ifndef SAFE_TELEOP_CORE__MSG__DETAIL__OBJECT_STATUS__TYPE_SUPPORT_H_
#define SAFE_TELEOP_CORE__MSG__DETAIL__OBJECT_STATUS__TYPE_SUPPORT_H_
...
#endif  // SAFE_TELEOP_CORE__MSG__DETAIL__OBJECT_STATUS__TYPE_SUPPORT_H_
