...
#ifndef SAFE_TELEOP_CORE__MSG__DETAIL__OBJECT_STATUS__FUNCTIONS_H_
#define SAFE_TELEOP_CORE__MSG__DETAIL__OBJECT_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * safe_teleop_core__msg__ObjectStatus__create()
 ...
 * calls
 * safe_teleop_core__msg__ObjectStatus__init().
...
/**
 * It calls
 * safe_teleop_core__msg__ObjectStatus__fini()
 ...
 * safe_teleop_core__msg__ObjectStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * safe_teleop_core__msg__ObjectStatus__Sequence__fini()
 * on the array,
...
#endif  // SAFE_TELEOP_CORE__MSG__DETAIL__OBJECT_STATUS__FUNCTIONS_H_
